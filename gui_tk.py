...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About Remibot", command=self.msg)
        ...
        self.send_button2 = Button(self.send_button_frame, text="Mic", width=5, relief=GROOVE, bg='white',
                                  bd=1, command=lambda: self.send_message_mic(None), activebackground="#FFFFFF",
                                  activeforeground="#000000")
        self.send_button2.pack(side=LEFT, ipady=8)
        self.master.bind("<Return>", self.send_message_mic)
    ...
    def send_message_mic(self, message):
        try:
            r = sr.Recognizer()
            with sr.Microphone() as source:
                ...
                msg = str(r.recognize_google(audio, language='en-us'))
                user_input = msg
                pr1 = "User: " + user_input + "\n"
            ...
            pr3 = "Please Check your internet Connection\n"
            self.text_box.configure(state=NORMAL)
            self.text_box.insert(END, pr3)
            self.text_box.configure(state=DISABLED)
            self.text_box.see(END)
        except sr.WaitTimeoutError:
            pr3 = "Please speak something!\n"
            self.text_box.configure(state=NORMAL)
            self.text_box.insert(END, pr3)
            self.text_box.configure(state=DISABLED)
            self.text_box.see(END)
        except sr.UnknownValueError:
            pr3 = "Sorry, I didn't understand that.\n"
            self.text_box.configure(state=NORMAL)
            self.text_box.insert(END, pr3)
            self.text_box.configure(state=DISABLED)
            self.text_box.see(END)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Remibot v1.0","Remibot is a chatbot for giving natural remedies about certain symptoms..\nIt is based on retrival-based NLP using python's NLTK tool-kit module.\nGUI is based on Tkinter.")

    def about(self):
        tkinter.messagebox.showinfo("Remibot Developers","1.Prithviraj Chauhan\n2.Debasmita Adak")
    ...
    def color_theme_default(self):
        ...
        self.send_button2.config(bg="#FFFFFF", fg="#000000", activebackground="#FFFFFF", activeforeground="#000000")
    ...
    def color_theme_dark(self):
        ...
        self.send_button2.config(bg="#212121", fg="#FFFFFF", activebackground="#212121", activeforeground="#FFFFFF")
    ...
    def color_theme_hacker(self):
        ...
        self.send_button2.config(bg="#0F0F0F", fg="#FFFFFF", activebackground="#0F0F0F", activeforeground="#FFFFFF")
